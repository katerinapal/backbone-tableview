...
var Tbody = _src.tbody.tbody;

describe('TBody', function () {
    beforeEach(function () {
        this.view = new _src.tbody();
        this.collection = new _backbone2.default.Collection([{ foo: 'bar0' }, { foo: 'bar1' }, { foo: 'bar2' }]);
    });
    ...
    it('Initializeing view with colleciton', function () {
        this.view = new _src.tbody({ collection: this.collection });
    ...
    it('Should stop listening when a colleciton is replaced', function () {
        ...
        this.view.setCollection.call(this.view, new _backbone2.default.Collection());
