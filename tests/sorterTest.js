...
describe('Sorter', function(){
    beforeEach(function(){
        this.collection = new ext_Backbone.Collection([
    ...
    it('should determain sort order up', function(){
        var m = new ext_Backbone.Model({state: 'up'})
    ...
    it('should determain sort order down', function(){
        var m = new ext_Backbone.Model({state: 'down'})
        var sorter = new Sorter(this.collection, 'name', function(){})
        var sort = sorter.getSorter()(m)
    ...
    it('should determain sort order null', function(){
        var m = new ext_Backbone.Model({state: null})
        var sorter = new Sorter(this.collection, 'name', function(){})
        var sort = sorter.getSorter()(m)
    ...
    it('reset', function(){
        ...
        var m2 = new ext_Backbone.Model({state: null})
